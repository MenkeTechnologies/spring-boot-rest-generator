...
class MainTest {
    ...
    fun getKey() {
        ...
        val expected = ColumnToField("@Id", "ACTIVITY_ID", null, null, "Integer")
    ...
    fun getKey2() {
        ...
        val expected = ColumnToField("@ManyToOne", "TRANSCRIPT_ID", "transcriptId", null, "Transcript")
        assertEquals(expected, Util.getId(foreignKey))
    }

    @Test
    fun getKey3() {
        val expected = ColumnToField("@ManyToOne", "TESTING_ID", "testingId", null, "Testing")
    ...
    @Test
    fun getKey4() {
        val expected = ColumnToField("@ManyToOne", "TESTING_NO_BAD_ID", "testingNoBadId", null, "TestingNoBad")
